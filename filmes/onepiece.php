...
<html>
    <head>
        <meta charset="UTF-8">
        <title>ONE PIECE - STRONG WORLD</title>
        ...
        <main>
            ...
            <div class="filmesinfo">
                <div class="banerfilme">
                    <img src="../imgs/one_piece_film.jpg" alt=""/>
                ...
                <div class="filmesdados">
                    <iframe width="520" height="310" src="https://www.youtube.com/embed/bHzosJJn7Vk">teste</iframe>
                    <h1>ONE PIECE - STRONG WORLD</h1>
                    <h2>Generos</h2>
                    <p>Animação</p>
                    <h2>Direção</h2>
                    <p>Munehisa Sakai</p>
                    <h2>Elenco</h2>
                    <p>Monkey D. Luffy Mayumi Tanaka, Zoro Roronoa Kazuya Nakai, Robin Nico Yuriko Yamaguchi</p>
                    <h2>Siniopse</h2>
                    <p> Depois de alguns anos desaparecido após sua fuga de Impel Down, Shiki, o Leão Dourado, antigo inimigo do Rei dos Piratas Gol D. Roger, volta à ativa e chega a Thriller Bark, onde começa a executar o plano que levou esse tempo todo para concretizar e finalmente conseguir sequestrar Nami. Agora, Ruffy e sua tripulação precisam ir atrás de Shiki para impedir que ele realize seus planos e consiga salvar a vida de Nami.</p>
                    <h2>Data de Lançamento</h2>
                    <p>2 de abril de 2009</p>
                    <h2>Duração</h2>
                    <p>1h 53min</p>
                    <div>
                        <form class="locarbtn" action="../locar.php" method="get">
                            <input type="hidden" value='24' name="n"/>
