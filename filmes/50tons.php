...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Cinquenta Tons Mais Escuros</title>
        ...
        <main>
            ...
            <div class="filmesinfo">
                <div class="banerfilme">
                    <img src="../imgs/50tondcinza.png" alt=""/>
                ...
                <div class="filmesdados">
                    <iframe width="520" height="310" src="https://www.youtube.com/embed/vJ41tFyuaFs">teste</iframe>
                    <h1>Cinquenta Tons Mais Escuros</h1>
                    <h2>Generos</h2>
                    <p>Romance, Drama, Erótico</p>
                    <h2>Direção</h2>
                    <p>James Foley</p>
                    <h2>Elenco</h2>
                    <p>Dakota Johnson, Jamie Dornan, Kim Basinger, Luke Grimes, Eloise Mumford, Max Martini, Tyler Hoechlin, Rowan Blanchard</p>
                    <h2>Siniopse</h2>
                    <p> Incomodada com os hábitos e atitudes de Christian Grey (Jamie Dornan), Anastasia (Dakota Johnson) decide terminar o relacionamento e focar no desenvolvimento de sua carreira. Ele, no entanto, não desiste tão fácil e fica sempre ao seu encalço, insistindo que aceita as regras dela. Tal cortejo acaba funcionando e ela reinicia o relacionamento com o jovem milionário, sendo que, aos poucos, passa a compreender melhor os jogos sexuais que ele tanto aprecia.</p>
                    <h2>Data de Lançamento</h2>
                    <p>9 de fevereiro de 2017</p>
                    <h2>Duração</h2>
                    <p>1h 58min</p>
                    <div>
                        <form class="locarbtn" action="../locar.php" method="get">
                            <input type="hidden" value='20' name="n"/>
