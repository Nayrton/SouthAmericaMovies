...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Planeta dos Macacos: A Guerra</title>
        ...
        <main>
            ...
            <div class="filmesinfo">
                <div class="banerfilme">
                    <img src="../imgs/planeta-dos-macacos.jpg" alt=""/>
                ...
                <div class="filmesdados">
                    ...
                    <div>
                        <form class="locarbtn" action="../locar.php" method="get">
                            <input type="hidden" value='14' name="n"/>
